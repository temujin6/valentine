...
export default function Weather() {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "https://api.open-meteo.com/v1/forecast?latitude=47.9077&longitude=106.8832&hourly=temperature_2m&timezone=Asia%2FSingapore&forecast_days=1"
        );
  ...
  if (!data || !data.hourly) return <p>Loading...</p>; // Handle loading state

  return (
    <div className="w-screen h-screen flex font-main p-6 bg-black">
      <div className="h-full w-20 bg-sky-950 rounded-2xl">
        ...
        <div className="w-20 h-20 flex justify-center items-center">
          <a
            href=""
            className="text-sm flex flex-col items-center text-zinc-400 font-medium"
          >
            <Image
              src="/list.webp"
              width={20}
              height={20}
              className="object-contain mb-1 brightness-200"
            />
            Weather
          </a>
        </div>
        <div className="w-20 h-20 flex justify-center items-center">
          ...
          >
            <Image
              ...
              width={20}
              height={20}
              className="object-contain mb-1 brightness-150"
            />
            Weather
          </a>
        </div>
      ...
      <div className="h-full w-[62%] px-4">
        <div className="h-12 w-full bg-sky-950 rounded-lg flex items-center pl-3">
          <p className="text-zinc-300 text-sm">Search for cities</p>
        </div>
        <div className="h-[91%] w-full mt-3 grid grid-rows-3 gap-y-3">
          <div className="flex justify-between">
            <div className="h-full w-40 grid grid-rows-3 place-content-end pt-8">
              <p className="font-semibold text-3xl leading-7 text-white">
                Madrid
                <br />
              ...
              <p></p>
              <p className="font-semibold text-5xl self-start text-white">
                31°
              </p>
            </div>
          ...
          <div className="bg-sky-950 rounded-2xl justify-between">
            ...
            <div className="w-[830px] h-40 flex overflow-x-auto snap-x snap-mandatory px-10 py-4 divide-x-[2px] divide-zinc-600/50">
              {(data.hourly.time || []).map((time, index) => (
                <div className="w-40 h-full flex flex-col items-center justify-between shrink-0">
                  <p className="text-sm text-zinc-300 font-bold">{time}</p>
                  <Image src="/sun.png" width={45} height={45} />
                  <p className="text-xl font-bold text-white">
                    {dayjs(data.hourly.temperature_2m[index]).format(
                      "YYY/MM/DD HH:mm"
                    )}
                    °C
                  </p>
              ...
              <div className="w-full h-full flex">
                <div className="h-full w-6 pt-1">
                  <Image
                    ...
                    width={18}
                    height={18}
                    className="m-auto brightness-200"
                  />
                </div>
                <div className="ml-2">
                  <p className="text-zinc-400">Wind</p>
                  <p className="text-2xl font-bold text-white">0.2 km/h</p>
                </div>
              </div>
              <div className="w-full h-full flex">
                <div className="h-full w-6 pt-1">
        ...
        <div className="w-full h-[90%] bg-sky-950 rounded-2xl p-8">
          ...
          <div className="w-full h-full grid grid-rows-7">
            <div className="w-full h-full grid grid-cols-3 border-b-2 border-zinc-400/25">
              <p className="font-medium text-zinc-400 flex items-center">
                Today
              </p>
              ...
              <p className="font-semibold flex items-center justify-end text-white">
                36<span className="text-zinc-400"> /22</span>
              </p>
            </div>
            <div className="w-full h-full grid grid-cols-3 border-b-2 border-zinc-400/25">
              ...
              <p className="font-semibold flex items-center justify-end text-white">
                37<span className="text-zinc-400"> /21</span>
              </p>
            </div>
            <div className="w-full h-full grid grid-cols-3 border-b-2 border-zinc-400/25">
